...
public class ProductController {
    ...
    public String findProductById(@PathVariable("id") Long id ,Model model){
        ...
        List<ProductDto> productDtoList = productService.findAllByCategory(product.getCategory().getCate_name());
    ...
    public String productsInCategory(@PathVariable("id") Long id, Model model) {
        ...
        model.addAttribute("title", productDtos.get(0).getCategory().getCate_name());
